...
void collect() {
    while (true) {
        ...
        if (evt.status == osEventMessage) {
            ...
            printf("Value: %d \n\r", event->value);
						printf("%d : ", event->timestamp->tm_year - 100);
						printf("%d : ", event->timestamp->tm_mon + 1);
						printf("%d : ", event->timestamp->tm_mday);
						printf("%d : ", event->timestamp->tm_hour - 5);
						printf("%d : ", event->timestamp->tm_min);
